  ...
  <button
    ...
    className={`w-full text-left px-4 py-2 text-sm flex items-center space-x-2 ${
      active
        ...
        : 'text-slate-700 hover:bg-emerald-50 dark:text-slate-700 dark:hover:bg-emerald-50'
    }`}
  >
...
export default function ThemeSelector() {
  ...
  return (
    <div className="relative inline-block text-left" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="origin-top-right absolute right-0 mt-2 w-40 rounded-md shadow-lg bg-white dark:bg-white ring-1 ring-emerald-200 dark:ring-emerald-300 ring-opacity-100 focus:outline-none z-50">
          <div className="py-1" role="none">
            <h3 className="px-4 py-2 text-xs font-semibold text-emerald-700 dark:text-emerald-700 uppercase tracking-wider">
              Color Theme
            </h3>
            ...
            <div className="border-t border-emerald-200 dark:border-emerald-200 my-1" />
            <button
              type="button"
              onClick={toggleDarkMode}
              className="w-full text-left px-4 py-2 text-sm flex items-center justify-between text-slate-700 hover:bg-emerald-50 dark:text-slate-700 dark:hover:bg-emerald-50"
            >
