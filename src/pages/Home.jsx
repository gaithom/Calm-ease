...
export default function Home() {
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-primary-50 to-white dark:from-slate-900 dark:to-slate-800">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-slate-900 dark:text-white mb-6">
            Find Your Calm,<br />
            <span className="text-primary-600 dark:text-primary-400">One Breath at a Time</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <CalmNowButton className="w-full sm:w-auto" />
            <Link
              to="/relax"
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-white bg-primary-500 hover:bg-primary-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200 shadow-lg hover:shadow-primary-500/30"
            >
              Start Relaxing
            </Link>
            <Link
              to="/grounding"
              className="inline-flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-full text-primary-700 bg-primary-100 hover:bg-primary-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors duration-200 dark:bg-slate-700 dark:text-primary-200 dark:hover:bg-slate-600"
            >
              Try Grounding
            </Link>
          </div>
      ...
      <section className="py-16 bg-white dark:bg-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {/* Feature 1 */}
            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border border-slate-100 dark:border-slate-700">
              <div className="w-16 h-16 bg-primary-100 dark:bg-slate-700 rounded-2xl flex items-center justify-center mb-4 mx-auto text-primary-500">
          ...
          {favoriteSounds.length === 0 ? (
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {favoriteSounds.map((sound) => (
                <div key={sound.id} className="relative rounded-2xl bg-white dark:bg-slate-800 p-6 shadow-sm hover:shadow-md border border-slate-200 dark:border-slate-700 transition-all duration-200 group">
                  <div className="flex items-start">
                    <div className="flex-shrink-0 h-14 w-14 rounded-2xl bg-primary-100 dark:bg-slate-700 flex items-center justify-center group-hover:bg-primary-200 dark:group-hover:bg-slate-600 transition-colors duration-200">
