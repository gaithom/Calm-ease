  ...
  theme: {
    extend: {
      colors: {
        ...
        // Primary colors - controlled by CSS variables
        primary: {
        ...
        // Gradient colors
        gradient: {
          from: 'rgb(var(--gradient-from) / <alpha-value>)',
          to: 'rgb(var(--gradient-to) / <alpha-value>)'
        },
        // Teal theme
        teal: {
          50: '#f0fdfa',
      ...
      backgroundImage: {
        ...
        'grid-slate-800/50': 'linear-gradient(to right, rgba(30, 41, 59, 0.5) 1px, transparent 1px), linear-gradient(to bottom, rgba(30, 41, 59, 0.5) 1px, transparent 1px)'
      },
      backgroundSize: {
        'grid-sm': '40px 40px',
        'grid-md': '60px 60px'
